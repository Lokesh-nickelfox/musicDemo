...
public abstract class TrackListScrollListener extends RecyclerView.OnScrollListener {

    private static final String TAG = TrackListScrollListener.class.getSimpleName();
    ...
    public TrackListScrollListener(LinearLayoutManager layoutManager) {
